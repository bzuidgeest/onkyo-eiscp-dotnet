...
namespace Eiscp.Core
{
	...
	{
		public static readonly Dictionary<string, OrderedDictionary> Commands = new Dictionary<string, OrderedDictionary>()
		{
			{
 				"main",
...
s -> Preset button : ""1"": button is enable, ""0"": button is disable
 rrr-> reserved"
    ...
    "e\nr -> Repeat Status: \"-\": Off\ns -> Shuffle Status: \"-\": Off"
		...
		public static readonly Dictionary<string, OrderedDictionary> CommandMappings = new Dictionary<string, OrderedDictionary>()
		{
			{
 				"main",
				new OrderedDictionary(StructuralComparisons.StructuralEqualityComparer)
		...
		public static readonly Dictionary<string, OrderedDictionary> ValueMappings = new Dictionary<string, OrderedDictionary>()
		{
			{
 				"main",
				new OrderedDictionary(StructuralComparisons.StructuralEqualityComparer)
